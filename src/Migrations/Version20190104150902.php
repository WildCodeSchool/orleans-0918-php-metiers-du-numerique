 ...
 */
final class Version20190104150902 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE learning_center (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, picture VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, mail VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, accepted TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, associated_job_id INT NOT NULL, picture VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, job VARCHAR(255) NOT NULL, company VARCHAR(255) DEFAULT NULL, cons_comment LONGTEXT NOT NULL, pros_comment LONGTEXT NOT NULL, comment LONGTEXT DEFAULT NULL, liked INT NOT NULL, accepted TINYINT(1) NOT NULL, post_date DATETIME NOT NULL, INDEX IDX_9474526C43BA71FC (associated_job_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, picture VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, accepted TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE job (id INT AUTO_INCREMENT NOT NULL, associated_category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, video VARCHAR(255) DEFAULT NULL, picture VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, video_description LONGTEXT DEFAULT NULL, video_title VARCHAR(255) DEFAULT NULL, INDEX IDX_FBD8E0F813765BC5 (associated_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
